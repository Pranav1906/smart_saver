...
app.post('/resolve/youtube', async (req, res) => {
    try {
        ...
        const cmd = buildYtDlpCommand(normalizedUrl, { getUrlsOnly: true });
        const { stdout, stderr } = await execAsync(cmd, { timeout: 30000 });
        // yt-dlp -g can return one or two lines (video and audio)
        ...
        res.json({ success: true, urls: lines, normalizedUrl });
    } catch (error) {
