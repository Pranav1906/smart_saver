...
app.post('/download/youtube', async (req, res) => {
    try {
        ...
        try {
            ...
            try {
                const fallbackCommand = `/opt/venv/bin/yt-dlp --force-ipv4 --geo-bypass --geo-bypass-country=US --no-playlist --merge-output-format mp4 --user-agent "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" --no-check-certificates --extractor-args "youtube:player_client=android" --add-header "Accept-Language:en-US,en;q=0.9" --add-header "Accept-Encoding:gzip, deflate, br" --add-header "DNT:1" --add-header "Connection:keep-alive" --add-header "Upgrade-Insecure-Requests:1" -f "bv*[ext=mp4]+ba[ext=m4a]/best" -o "${outputPath}" "${normalizedUrl}"`;
                ...
                try {
                    ...
                    const thirdFallbackCommand = `/opt/venv/bin/yt-dlp --force-ipv4 --geo-bypass --no-playlist --merge-output-format mp4 --user-agent "Mozilla/5.0 (Linux; Android 10; SM-G975F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36" --no-check-certificates --extractor-args "youtube:player_client=android" --add-header "Accept-Language:en-US,en;q=0.9" --add-header "Accept-Encoding:gzip, deflate, br" --add-header "DNT:1" --add-header "Connection:keep-alive" --add-header "Upgrade-Insecure-Requests:1" --format "bv*[ext=mp4][height<=720]+ba/b[height<=720]" -o "${outputPath}" "${normalizedUrl}"`;
                    ...
                    try {
                        console.log('Trying fourth fallback with iOS client...');
                        const fourthFallbackCommand = `/opt/venv/bin/yt-dlp --force-ipv4 --geo-bypass --no-playlist --merge-output-format mp4 --user-agent "Mozilla/5.0 (iPhone; CPU iPhone OS 16_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.0 Mobile/15E148 Safari/604.1" --no-check-certificates --extractor-args "youtube:player_client=ios" --add-header "Accept-Language:en-US,en;q=0.9" --add-header "Accept-Encoding:gzip, deflate, br" --add-header "DNT:1" --add-header "Connection:keep-alive" --add-header "Upgrade-Insecure-Requests:1" -f "bv*[ext=mp4]+ba/best" -o "${outputPath}" "${normalizedUrl}"`;
                        ...
                        try {
                            console.log('Trying fifth fallback with web client...');
                            const fifthFallbackCommand = `/opt/venv/bin/yt-dlp --force-ipv4 --geo-bypass --no-playlist --merge-output-format mp4 --user-agent "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" --no-check-certificates --extractor-args "youtube:player_client=web" --format "bv*[ext=mp4][height<=720]+ba[ext=m4a]/b[ext=mp4][height<=720]" -o "${outputPath}" "${normalizedUrl}"`;
                            ...
                            try {
                                ...
                                const sixthFallbackCommand = `/opt/venv/bin/yt-dlp --force-ipv4 --no-playlist --merge-output-format mp4 -o "${outputPath}" "${normalizedUrl}"`;
                                ...
                                if (errorMessage.includes('Sign in to confirm you\'re not a bot') || 
                                    ...
                                    res.status(500).json({
                                        ...
                                        stderr: sixthFallbackError.stderr || ''
                                    });
                                }
                            }
                        }
